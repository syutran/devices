...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post branches_url, params: { branch: { branch: @branch.branch, branch_id: @branch.branch_id, description: @branch.description, master_id: @branch.master_id } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { branch: @branch.branch, branch_id: @branch.branch_id, description: @branch.description, master_id: @branch.master_id } }
